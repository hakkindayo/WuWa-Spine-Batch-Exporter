# List of items with bugs (confirmed so far)
1. Heavy visual effects may cause flickering in `.mov` output
Videos with heavy visual effects may flicker significantly when exported as `.mov`.
...
# バグが起きるもの一覧(確認したもので)
1.エフェクトが激しいものが.movで映像で出力した場合激しく点滅する可能性があります！(mp4は黒背景だけどし点滅することはありません)
